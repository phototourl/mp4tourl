        ...
        <div className="space-y-3 text-center mb-8">
          <h1 className="flex items-center justify-center gap-3 text-xl font-semibold tracking-tight text-slate-900 sm:text-3xl lg:text-4xl">
            <div className="h-8 w-8 rounded-xl overflow-hidden sm:h-10 sm:w-10 lg:h-12 lg:w-12">
              <NextImage
                src="/circle-crop.png"
                alt="Circle crop tool - crop any photo into a perfect circle"
                width={48}
                height={48}
          ...
          <>
            ...
            <div className="w-full max-w-[480px] mt-4">
              <Button
                ...
                disabled={isCropping}
                className="w-full px-12 py-6 text-lg cursor-pointer bg-brand-teal border-2 border-brand-teal text-white hover:bg-white hover:border-black hover:text-black transition-colors font-medium disabled:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed"
              >
                {isCropping ? (
                  <>
