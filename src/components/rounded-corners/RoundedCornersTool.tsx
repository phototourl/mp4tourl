          ...
          <h1 className="flex items-center justify-center gap-3 text-xl font-semibold tracking-tight text-slate-900 sm:text-3xl lg:text-4xl">
            <div className="h-8 w-8 flex items-center justify-center flex-shrink-0 sm:h-10 sm:w-10 lg:h-12 lg:w-12">
              <NextImage
                ...
                alt="Rounded corners tool - add smooth rounded corners to any photo"
                width={48}
                height={48}
          ...
          <>
            <div className="mt-6 w-full max-w-[480px] space-y-4">
              ...
              <Button
                ...
                className="w-full px-12 py-6 text-lg bg-brand-teal border-2 border-brand-teal text-white hover:bg-white hover:border-black hover:text-black transition-colors font-medium disabled:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed"
              >
                {isExporting ? (
