...
export function ContactFormCard() {
  ...
  return (
    <Card className="mx-auto max-w-lg overflow-hidden border-slate-200 pt-6 pb-0">
      <CardHeader>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <CardFooter className="mt-4 flex items-center border-t border-slate-100 bg-slate-50/50 px-6 py-4">
