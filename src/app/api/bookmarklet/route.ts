...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://www.mp4tourl.com";

export async function GET() {
  // Inline bookmarklet served at /api/bookmarklet (2MB free-tier limit)
    ...
    fetch(imageUrl)
      ...
      .then(function(blob) {
        if (blob.size > 2 * 1024 * 1024) {
          throw new Error('Image too large. Max 2MB on free tier.');
        }
