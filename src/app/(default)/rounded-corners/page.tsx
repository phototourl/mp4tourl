...
import { RoundedCornersTool } from "@/components/rounded-corners/RoundedCornersTool";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  for (const l of routing.locales) {
    languages[l] = l === locale
      ? `${siteUrl}/rounded-corners`
      : `${siteUrl}/${l}/rounded-corners`;
  }
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Rounded Corners Tool - Add rounded corners to any photo online",
        },
      ],
    },
    twitter: {
...
export default async function RoundedCornersPage() {
  ...
  const tSeo = await getTranslations("roundedCorners.seo");

  // WebApplication schema for this tool
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "WebApplication",
    "@id": `${siteUrl}/rounded-corners#webapp`,
    "name": tSeo("title"),
    "description": tSeo("description"),
    "url": `${siteUrl}/rounded-corners`,
