...
export default async function PrivacyPolicyPage({
  ...
  return (
    <LegalPage>
      ...
      <section className="mt-8">
        <h2 className="text-xl font-semibold mb-4">{t("personalizedAds.title")}</h2>
        <p className="text-slate-700">
          {t("personalizedAds.content")}{" "}
          <a className="text-blue-600 hover:underline" href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer">
            {t("personalizedAds.linkAdsSettings")}
          </a>
          {" "}{t("personalizedAds.content2")}{" "}
          <a className="text-blue-600 hover:underline" href="https://www.aboutads.info/choices" target="_blank" rel="noopener noreferrer">
            {t("personalizedAds.linkAboutAds")}
          </a>
          {t("personalizedAds.content3")}
        </p>
      </section>
