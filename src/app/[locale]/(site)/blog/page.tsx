      ...
      {posts.length === 0 ? (
        ...
        <div className="grid gap-4 md:gap-5 md:grid-cols-2">
          {await Promise.all(posts.map(async (post) => {
            ...
            return (
              <Link key={post.id} href={postPath} className="block rounded-xl overflow-hidden border border-slate-200 hover:shadow-md hover:border-slate-300 transition-all cursor-pointer">
                ...
                <div className="bg-white px-4 pb-4">
                  <div className="flex items-center gap-2 text-xs text-slate-500 mb-2 mt-3">
                  ...
                  <h2 className="text-lg md:text-xl font-semibold mb-2 leading-tight line-clamp-2 text-slate-900">
                    {title}
                  </h2>
